  ...
  return (
    ...
    >
      ...
      >
        ...
        {/* BACK (Frente/Conteúdo) */}
        <div 
          className="absolute inset-0 w-full h-full rounded-xl overflow-hidden border-[3px] border-white/50 bg-[#F8F9FA]"
          style={{ 
        ...
        >
            ...
            <div 
                className="absolute bottom-[4%] left-[4%] right-[4%] h-[16%] flex items-center justify-center bg-white/80 rounded-lg backdrop-blur-sm px-1 shadow-sm"
